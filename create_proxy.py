...
def create_blob_source(app_name, blob_path):
    ...
    blob_put_headers = headers
    response = requests.post(url=blob_source_request_url, headers=blob_put_headers)
    ...
    if response.status_code == 201:
        ...
        blob_put_headers["Content-Type"] = "--data-binary @source.tgz"
